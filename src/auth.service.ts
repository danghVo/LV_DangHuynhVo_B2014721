import { Injectable, ForbiddenException, UnauthorizedException, Session } from '@nestjs/common';
...
export class AuthService {
    ...
    async validSignUpPayload(signUpDto: SignUpDto): Promise<{ isValid: boolean; error: string }> {
